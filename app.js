...
function populateShipmentModalCountries() {
  ...
  countries.forEach(c => {
    select.innerHTML += `<option value="${c.country_code}">${c.flag} ${c.country_name}</option>`;
  });
}
